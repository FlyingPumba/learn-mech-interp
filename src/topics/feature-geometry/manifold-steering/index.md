...
The broader lesson is methodological. Representation geometry should earn its role through held-out prediction and intervention, not visual appeal alone. When the evidence does support a curved structure, the path between concepts becomes part of the mechanistic hypothesis. The next curriculum block begins with [Logit Diff Amplification](/topics/logit-diff-amplification/) and asks a complementary question: how do learned representations and behaviors change across model variants and training stages?
