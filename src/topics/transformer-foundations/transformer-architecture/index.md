...
The key point: you give the model text, the tokenizer gives you a sequence of integers, and this process is invertible. For the rest of this article, we will take tokenization as a black box and focus on what happens once we have our sequence of token IDs.
