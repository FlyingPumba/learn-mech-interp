...
This article completes the Transformer Foundations block. We have covered the full pipeline: from [token embeddings and the architecture](/topics/transformer-architecture/) through the [attention mechanism](/topics/attention-mechanism/), [MLPs](/topics/mlps-in-transformers/), [layer normalization](/topics/layer-normalization/), the [QK/OV circuit decomposition](/topics/qk-ov-circuits/), [head composition](/topics/composition-and-virtual-heads/), and now decoding. With these building blocks in place, we are ready to move to the [foundational concepts of interpretability](/topics/what-is-mech-interp/) and the techniques used to analyze these components in practice.
